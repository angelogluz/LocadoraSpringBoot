...
public class TesteFilme {
  ...
  @Test
  public void testeFilme() throws FilmeSemNomeException, FilmeSemEstoqueException{
    ...
    when(filme.setEstoque(0)).thenReturn("Sem estoque");
    when(filme.setEstoque(4)).thenReturn("Filme com preço");
    when(filme.setEstoque(0)).thenReturn("Filme sem preço");
